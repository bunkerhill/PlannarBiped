...
tic
%% MPC Parameters
global i_MPC_var dt_MPC_vec gait x_traj_IC Contact_Jacobian Rotm_foot addArm MPC_controller x_z xy_com
...
L = 0.525;
ddxy_s = [0;0];
x_z_dot = MPC_controller.MPC(xy_com,x_z,ddxy_s);
MPC_controller = MPC_controller.updatetime();

x_z = x_z + dT * x_z_dot;
xy_com = lip_dynamics(xy_com,x_z,ddxy_s,dT,L,g);
% [x(10);x(11)]
