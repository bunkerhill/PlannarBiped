...
%                     fprintf("%d\n",temp2);
                    N = round(obj.double_support_time/obj.deta);
                    dStep = obj.step_size/(N+1);
                    
                    x_min_next = temp1 * obj.step_size - 0.5 * obj.foot_length + dStep*(1 + temp2 - round(obj.single_support_time/obj.deta));
                    x_max_next = temp1 * obj.step_size + 0.5 * obj.foot_length + dStep*(1 + temp2 - round(obj.single_support_time/obj.deta));
                end
            end
        end
        ...
        function [y_min_next,y_max_next] = one_ZMP_rangey(obj,current_T)
            ...
            if current_T < timer
                ...
                if temp2 < round(obj.single_support_time/obj.deta)
                    ...
                    N = round(obj.double_support_time/obj.deta);
                    dStep = obj.step_width/(N+1);

                    y_min_next = (-1)^temp1 * 0.5 * obj.step_width - 0.5 * obj.foot_length - (-1)^temp1 * dStep * (1 + temp2 - round(obj.single_support_time/obj.deta));
                    y_max_next = (-1)^temp1 * 0.5 * obj.step_width + 0.5 * obj.foot_length - (-1)^temp1 * dStep * (1 + temp2 - round(obj.single_support_time/obj.deta));
                end
            end
        end
            ...
            for i = 1:vector_length
                ...
                if current_T < timer
                    ...
                    if temp2 < round(obj.single_support_time/obj.deta)
                        ...
                        X_min_next(i) = temp1 * obj.step_size - 0.5 * obj.foot_length + dStep*(1 + temp2 - round(obj.single_support_time/obj.deta));
                        X_max_next(i) = temp1 * obj.step_size + 0.5 * obj.foot_length + dStep*(1 + temp2 - round(obj.single_support_time/obj.deta));
                    end
            ...
            for i = 1:vector_length
                ...
                if current_T < timer
                    ...
                    if temp2 < round(obj.single_support_time/obj.deta)
                        ...
                        Y_min_next(i) = (-1)^temp1 * 0.5 * obj.step_width - 0.5 * obj.foot_length - (-1)^temp1 * dStep * (1 + temp2 - round(obj.single_support_time/obj.deta));
                        Y_max_next(i) = (-1)^temp1 * 0.5 * obj.step_width + 0.5 * obj.foot_length - (-1)^temp1 * dStep * (1 + temp2 - round(obj.single_support_time/obj.deta));
                    end
                end
