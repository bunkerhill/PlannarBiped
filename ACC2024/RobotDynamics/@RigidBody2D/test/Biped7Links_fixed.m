...
theta5 = sym('theta5');
theta6 = sym('theta6');
generalCoordinates = [theta0, theta1, theta2, theta3, theta4, theta5, theta6];
...
dtheta5 = sym('dtheta5');
dtheta6 = sym('dtheta6');
generalVelocities = [dtheta0, dtheta1, dtheta2, dtheta3, dtheta4, dtheta5, dtheta6];
...
% Body
link0 = CoordinateFrame2D('Name', 'link0', 'ParentFrame', base, 'Rotation', SO2(theta0));
