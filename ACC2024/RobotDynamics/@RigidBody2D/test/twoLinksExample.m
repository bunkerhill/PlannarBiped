...
com1 = Point2D('X', l1/2); % COM (center of mass) location [l1/2, 0]
I1 = sym('I1'); % moment of inertial around COM
m2 = sym('m2'); % mass of second link
l2 = sym('l2'); % length of second link
com2 = Point2D('X', l2/2); % COM (center of mass) location [l2/2, 0]
...
%% Second link
link2 = CoordinateFrame2D('Name', 'link2', 'ParentFrame', link1, 'Rotation', SO2(theta2), 'Displacement', Point2D('X', l1))
